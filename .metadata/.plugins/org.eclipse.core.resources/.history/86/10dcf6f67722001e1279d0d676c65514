...
int8_t X_js_2 = 0;		 //coordenadas en X
int8_t Y_js_2 = 0;		 //coordenadas en Y
...
{
	I2C_MasterStart(I2C1, ADDRS_JS_2, kI2C_Read);
...
//    CLOCK_Select(BOARD_DEBUG_USART_CLK_ATTACH);
    ...
    PINT_PinInterruptConfig(PINT, kPINT_PinInt1, kPINT_PinIntEnableFallEdge , pint_intr_callback_K3);
